             ...
             children: [
               ...
               Container(padding: EdgeInsets.symmetric(vertical: 12),
                 ...
                 child: GestureDetector(
                   onTap: null,
                   child: Center(
                     child: Text("About Us",style: TextStyle(color: Colors.grey[900],fontSize: 20),),
                   ),
                 ),
               ),
               ...
               Container(padding: EdgeInsets.symmetric(vertical: 12),
                 ...
                 child: GestureDetector(
                   onTap: null,
                   child: Center(
                     child: Text("Know Developers",style: TextStyle(color: Colors.grey[900],fontSize: 20),),
                   ),
                 ),
               ),
               SizedBox(height: MediaQuery.of(context).size.height*0.02,),
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                Padding(
                  ...
                  child: AutoSizeText("Hello "+"XYZ"+" !",
                    ...
                    :travelCard(_postjson[index-1]["name"], _postjson[index-1]["date"].toString(), _postjson[index-1]["price"], _postjson[index-1]["venue"], _postjson[index-1]["id"], username.toString(), context);
