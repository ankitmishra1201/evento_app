        ...
        child: ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              return index == 0
                  ...
                  : travelCard(_postjson[index-1]["name"], _postjson[index-1]["date_time"], _postjson[index-1]["price"], _postjson[index-1]["venue"],
                      _postjson[index - 1]["id"], username.toString(), context);
            }),
      )),
...
Widget travelCard(String name, String date, var price, String location, int id,
    ...
    child: Card(
      ...
      child: Material(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => MoreInfo(id, username)));
          },
          child: Column(
            children: [
              SizedBox(
